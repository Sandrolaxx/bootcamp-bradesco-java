...
import desafiosoduku.model.Board;
import desafiosoduku.model.Space;
import desafiosoduku.util.BoardTemplate;
...
public class Main {
    ...
    public static void main(String[] args) {
        final var positions = Stream.of(BoardTemplate.GAME_CONFIG)
                .collect(Collectors.toMap(
                        k -> k.getX() + "," + k.getY(),
                        v -> v.getValue() + "," + v.isFixed()));
        var option = -1;
        while (true) {
